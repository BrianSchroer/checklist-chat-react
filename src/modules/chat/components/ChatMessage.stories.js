...
storybookStories('ChatMessage')
  ...
  .add('chatMessageType.CHAT - multiline', () => (
    <ChatMessage
      chatMessage={{
        chatMessageType: chatMessageType.CHAT,
        userName: 'User Name',
  ...
  .add('chatMessageType.ACTION long message', () => (
    <ChatMessage
      chatMessage={{
        ...
        timeStamp: '2016-12-08T23:57:10.222Z',
        text:
          'has done something. Something very important that takes multiple lines of text to describe. Look how beautifully the seondary and tertiary lines wrap following the primary line! Italics remind me of the leaning tower of Pisa. Mmmmm... pizza...'
      }}
    />
  ));
